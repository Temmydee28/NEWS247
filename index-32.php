					...
					<ul class="authors_list rating">
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Debora Hilton">
							...
							<div class="content">
								...
								<h6>EDITOR</h6>
								<h2><a href="index-33.htm?page=author" title="Debora Hilton">Debora Hilton</a></h2>
						...
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Anna Shubina">
							...
							<div class="content">
								...
								<h6>EDITOR</h6>
								<h2><a href="index-33.htm?page=author" title="Anna Shubina">Anna Shubina</a></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est lobortis laoreet.</p>
								<a href="index-33.htm?page=author" class="more highlight margin_top_15">PROFILE</a>
							</div>
						</li>
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Lian Holden">
							...
							<div class="content">
								...
								<h6>PUBLISHER</h6>
								<h2><a href="index-33.htm?page=author" title="Lian Holden">Lian Holden</a></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est lobortis laoreet.</p>
								<a href="index-33.htm?page=author" class="more highlight margin_top_15">PROFILE</a>
							</div>
						</li>
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Linda Gareth">
							...
							<div class="content">
								...
								<h6>PUBLISHER</h6>
								<h2><a href="index-33.htm?page=author" title="Linda Gareth">Linda Gareth</a></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est lobortis laoreet.</p>
								<a href="index-33.htm?page=author" class="more highlight margin_top_15">PROFILE</a>
							</div>
						</li>
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Alex van Holden">
							...
							<div class="content">
								...
								<h6>PUBLISHER</h6>
								<h2><a href="index-33.htm?page=author" title="Alex van Holden">Alex van Holden</a></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est lobortis laoreet.</p>
								<a href="index-33.htm?page=author" class="more highlight margin_top_15">PROFILE</a>
							</div>
						</li>
						<li class="author clearfix">
							<div class="avatar_block">
								<a href="index-33.htm?page=author" title="Heather Dale">
							...
							<div class="content">
								...
								<h6>ILLUSTRATOR</h6>
								<h2><a href="index-33.htm?page=author" title="Heather Dale">Heather Dale</a></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est lobortis laoreet.</p>
								<a href="index-33.htm?page=author" class="more highlight margin_top_15">PROFILE</a>
							</div>
						</li>
			...
			<div class="column column_1_3">
						...
						<ul class="blog rating page_margin_top clearfix">
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="index-20.htm?page=post_small_image" title="Syrian Civilians Trapped for Months Continue to be Evacuated">Syrian Civilians Trapped for Months Continue to be Evacuated</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="index-34.htm?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
									</ul>
								</div>
				...
				<div class="vertical_carousel_container clearfix">
					<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="index-20.htm?page=post_small_image" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">
								<img src='images/samples/100x100/image_12.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="index-20.htm?page=post_small_image" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">Syrian Civilians Trapped For Months Continue To Be Evacuated</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-18.htm?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
									<li class="date">
						...
						<li class="post">
							<a href="index-24.htm?page=post_quote" title="Built on Brotherhood, Club Lives Up to Name">
								<img src='images/samples/100x100/image_02.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="index-24.htm?page=post_quote" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
									<li class="date">

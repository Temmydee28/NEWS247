					...
					<ul class="small_slider id-small_slider">
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="index-1.htm?page=post" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a></h2>
						...
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="index-1.htm?page=post" title="Nuclear Fusion Closer to Becoming a Reality">Climate Change Debate While Britain Floods</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="index-1.htm?page=post" title="Nuclear Fusion Closer to Becoming a Reality">The Public Health Crisis Hiding in Our Food</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="index-1.htm?page=post" title="Nuclear Fusion Closer to Becoming a Reality">Built on Brotherhood, Club Lives Up to Name</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
					</ul>
			...
			<div class="column column_1_3">
				...
				<div class="vertical_carousel_container clearfix">
					<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="index-25.htm?page=post_quote_2" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">
								<img src='images/samples/100x100/image_12.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="index-25.htm?page=post_quote_2" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">Syrian Civilians Trapped For Months Continue To Be Evacuated</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-18.htm?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
									<li class="date">
						...
						<li class="post">
							<a href="index-23.htm?page=post_soundcloud" title="Built on Brotherhood, Club Lives Up to Name">
								<img src='images/samples/100x100/image_02.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="index-23.htm?page=post_soundcloud" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
									<li class="date">

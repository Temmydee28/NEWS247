...
if (isset($_REQUEST['category'])){
	...
	$sql= "SELECT * FROM newsupload WHERE category='$_REQUEST[category]'";
		...
		<div class="row">
			<div class="column column_2_3">
				<div class="row">
					<ul class="blog big">
					<?php
 $sql= "SELECT * FROM newsupload WHERE category='$_REQUEST[category]'  ORDER BY `category` DESC LIMIT 0, 10";
 //SELECT * FROM `newsupload` ORDER BY `id` DESC LIMIT 0, 5";
 $result = mysqli_query($conn, $sql);
...
?>
						...
						<li class="post">
							<a href="index-1.php?page=post" title="<?php echo $row['headline']; ?>">
								<img src='Login/passport/<?php echo $row['coverphoto'];?>' alt='img'>
							</a>
							<div class="post_content">
								<h2 class="with_number">
									<a <?php echo "href ='index-1.php?id=".$row['id']."'";?> title="<?php echo $row['headline']; ?>"><?php echo $row['headline']; ?></a>
								...
								<a class="read_more" <?php echo "href ='index-1.php?id=".$row['id']."'"; ?>  title="Read more"><span class="arrow"></span><span>READ MORE</span></a>
							</div>
						</li>
						<?php
	}}
						...
						<ul class="blog rating page_margin_top clearfix">
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="index-25.htm?page=post_quote_2" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="index-18.htm?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
									</ul>
								</div>
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="index-20.htm?page=post_small_image" title="Seeking the Right Chemistry, Drug Makers Hunt for Mergers">Seeking the Right Chemistry, Drug Makers Hunt for Mergers</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
									</ul>
								</div>

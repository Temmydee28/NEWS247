		...
		<div class="site_container">
			...
			<div class="header_top_bar_container clearfix">
				<div class="header_top_bar">
					...
					<ul class="social_icons clearfix dark">
						...
						<li>
							<a target="_blank" href="../../QuanticaLabs-1.html" class="social_icon twitter" title="twitter">
								&nbsp;
							</a>
						</li>
						<li>
						...
						<li>
							<a href="../../user/quanticalabs/portfolio.html" class="social_icon envato" title="envato">
								&nbsp;
							</a>
						</li>
						<!--<li>
			...
			<div class="header_container">
				<div class="header clearfix">
					<div class="logo">
						<h1><a href="index-2.htm?page=home" title="Pressroom">Pressroom</a></h1>
...
<ul class="sf-menu">
	<li class="submenu">
		...
		<ul>
			<li>
				<a href="index-2.htm?page=home" title="Home Style 1">
					Home Style 1
				</a>
			</li>
			<li>
				<a href="index-3.htm?page=home_2" title="Home Style 2">
					Home Style 2
				</a>
			</li>
			<li>
				<a href="index-4.htm?page=home_3" title="Home Style 3">
					Home Style 3
				</a>
			</li>
			<li>
				<a href="index-5.htm?page=home_4" title="Home Style 3">
					Home Style 4
				</a>
			</li>
			<li>
				<a href="index-6.htm?page=home_5" title="Home Style 5">
					Home Style 5
				</a>
			</li>
			<li>
				<a href="index-7.htm?page=home_6" title="Home Style 6">
					Home Style 6
				</a>
			</li>
			<li>
				<a href="index-8.htm?page=home_7" title="Home Style 7">
					Home Style 7
				</a>
			</li>
		</ul>
	...
	<li class="submenu">
		...
		<ul>
			<li>
				<a href="index-9.htm?page=about" title="About Style 1">
					About Style 1
				</a>
			</li>
			<li>
				<a href="index-10.htm?page=about_2" title="About Style 2">
					About Style 2
				</a>
			</li>
			<li>
				<a href="index-11.htm?page=default" title="Default">
					Default
				</a>
			</li>
			<li>
				<a href="index-12.htm?page=404" title="404 Not Found">
					404 Not Found
				</a>
			</li>
		</ul>
	...
	<li class="submenu mega_menu_parent">
		...
		<ul>
			<li class="submenu">
				<a href="index-13.htm?page=blog" title="Latest Posts">
					Latest Posts
				</a>
			...
			<li class="submenu">
				<a href="index-13.htm?page=blog" title="Recent Galleries">
					Recent Galleries
				</a>
				<ul class="mega_menu blog">
					<li class="post">
			...
			<li class="submenu">
				<a href="index-13.htm?page=blog" title="Recent Reviews">
					Recent Reviews
				</a>
				<ul class="mega_menu blog">
					<li class="post">
			...
			<li class="submenu">
				<a href="index-13.htm?page=blog" title="Most Read">
					Most Read
				</a>
	...
	<li class="submenu">
		<a href="index-13.htm?page=blog" title="Blog">
			Blog
		</a>
		<ul>
			<li>
				<a href="index-26.htm?page=blog_small_slider" title="Blog Small Slider">
					Blog Small Slider
				</a>
			</li>
			<li class="submenu">
				...
				<ul>
					<li>
						<a href="index-13.htm?page=blog" title="Blog With Right Sidebar">
							Blog With Right Sidebar
						</a>
					</li>
					<li>
						<a href="index-27.htm?page=blog_left_sidebar" title="Blog With Left Sidebar">
			...
			<li class="submenu">
				...
				<ul>
					<li>
						<a href="index-28.htm?page=blog_2_columns" title="Right Sidebar">
							Right Sidebar
						</a>
					</li>
					<li>
						<a href="index-29.htm?page=blog_2_columns_left_sidebar" title="Left Sidebar">
							Left Sidebar
						</a>
					</li>
				</ul>
			...
			<li>
				<a href="index-30.htm?page=blog_3_columns" title="Blog 3 Columns">
					Blog 3 Columns
				</a>
			</li>
			<li>
				<a href="index-31.htm?page=search&amp;s=Maecenas+Mauris" title="Search Page Template">
	...
	<li class="submenu">
		<a href="index-32.htm?page=authors" title="Authors">
			Authors
		</a>
		<ul>
			<li>
				<a href="index-32.htm?page=authors" title="Authors List">
					Authors List
				</a>
			</li>
			<li>
				<a href="index-33.htm?page=author" title="Author Single">
					Author Single
				</a>
			</li>
		</ul>
	...
	<li class="submenu">
		...
		<ul>
			<li>
				<a href="index-14.htm?page=category&amp;cat=health" title="Health">
					Health
				</a>
			</li>
			<li>
				<a href="index-34.htm?page=category&amp;cat=science" title="Science">
					Science
				</a>
			</li>
			<li>
				<a href="index-19.htm?page=category&amp;cat=sports" title="Sports">
					Sports
				</a>
			</li>
			<li>
				<a href="index-18.htm?page=category&amp;cat=world" title="World">
					World
				</a>
			</li>
			<li>
				<a href="index-35.htm?page=category&amp;cat=lifestyle" title="Lifestyle">
					Lifestyle
				</a>
			</li>
		</ul>
	...
	<li class="submenu">
		<a href="index-36.htm?page=contact" title="Contact">
			Contact
		</a>
		<ul class="expand_left_contact">
			<li>
				<a href="index-36.htm?page=contact" title="Contact Style 1">
					Contact Style 1
				</a>
			</li>
			<li>
				<a href="index-37.htm?page=contact_2" title="Contact Style 2">
					Contact Style 2
				</a>
			</li>
		</ul>
	...
	<ul class="mobile-menu">
		...
		<li class="submenu">
			...
			<ul>
				...
				<li class="submenu">
					<a href="index-13.htm?page=blog" title="Blog 1 column">
						Blog 1 Column
					</a>
					<ul>
						<li>
				...
				<li class="submenu">
					<a href="index-28.htm?page=blog_2_columns" title="Blog 2 columns">
						Blog 2 Columns
					</a>
					<ul>
						<li>
		...
		<li class="submenu">
			<a href="index-14.htm?page=category&amp;cat=health" title="Categories">
				Categories
			</a>
			<ul>
				<li>
				...
				<div class="horizontal_carousel_container small">
					<ul class="blog horizontal_carousel autoplay-1 scroll-1 visible-3 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post first">
							...
							<h5><a href="index-20.htm?page=post_small_image" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a></h5>
							<ul class="post_details simple">
								<li class="category"><a href="index-14.htm?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
								<li class="date">
									10:11 PM, Feb 02
		...
		<div class="row page_margin_top">
			<div class="column column_2_3">
				<div class="row">
					<div class="post single small_image">
						...
						<ul class="post_details clearfix">
							<li class="detail category">In <a href="index-14.htm?page=category&amp;cat=health" title="HEALTH">Health</a></li>
							<li class="detail date">8:25 PM, Feb 23</li>
							<li class="detail author">By <a href="index-33.htm?page=author" title="Anna Shubina">Anna Shubina</a></li>
						...
						<div class="post_content page_margin_top_section clearfix">
							<div class="content_box">
								...
								<div class="text">
									...
									<a title="6 Comments" href="index-1.htm?page=post" class="read_more page_margin_top scroll_to_comments"><span class="arrow"></span><span>6 COMMENTS</span></a>
								</div>
								<div class="author_box animated_element">
									<div class="author">
										...
										<div class="details">
											<h5><a title="Anna Shubina" href="index-33.htm?page=author">Anna Shubina</a></h5>
											<h6>EDITOR</h6>
				...
				<div class="row page_margin_top_section">
					...
					<div class="horizontal_carousel_container page_margin_top">
						<ul class="blog horizontal_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
							<li class="post">
								<a href="index-24.htm?page=post_quote" title="New Painkiller Rekindles Addiction Concerns">
									<img src='images/samples/330x242/image_08.jpg' alt='img'>
								</a>
								<h5><a href="index-24.htm?page=post_quote" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a></h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-14.htm?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
									<li class="date">
										10:11 PM, Feb 02
				...
				<div class="row page_margin_top_section">
					...
					<form class="comment_form margin_top_15" id="comment_form" method="post" action="/Pressroom/Template/?page=post_small_image">
			...
			<div class="column column_1_3">
				<div class="tabs no_scroll clearfix">
					...
					<div id="sidebar-most-read">
						<ul class="blog rating page_margin_top clearfix">
							<li class="post">
								<a href="index-23.htm?page=post_soundcloud" title="Nuclear Fusion Closer to Becoming a Reality">
						...
						<ul class="blog rating page_margin_top clearfix">
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="index-20.htm?page=post_small_image" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="index-18.htm?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
									</ul>
								</div>
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="index-25.htm?page=post_quote_2" title="Syrian Civilians Trapped for Months Continue to be Evacuated">Syrian Civilians Trapped for Months Continue to be Evacuated</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="index-34.htm?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
									</ul>
								</div>
				...
				<div class="vertical_carousel_container clearfix">
					<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="index-20.htm?page=post_small_image" title="Nuclear Fusion Closer to Becoming a Reality">
								<img src='images/samples/100x100/image_13.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="index-20.htm?page=post_small_image" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="index-34.htm?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
									<li class="date">
				...
				<div class="horizontal_carousel_container big page_margin_top">
					<ul class="blog horizontal_carousel visible-1 autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						<li class="post">
							<a href="index-22.htm?page=post_video_2" title="Struggling Nuremberg Sack Coach Verbeek">
								<span class="icon video"></span>
								<img src='images/samples/330x242/image_03.jpg' alt='img'>
							</a>
							<h5 class="with_number">
								<a href="index-22.htm?page=post_video_2" title="Struggling Nuremberg Sack Coach Verbeek">Struggling Nuremberg Sack Coach Verbeek</a>
						...
						<li class="post">
							<a href="index-21.htm?page=post_video" title="Built on Brotherhood, Club Lives Up to Name">
								<span class="icon video"></span>
								<img src='images/samples/330x242/image_14.jpg' alt='img'>
							</a>
							<h5 class="with_number">
								<a href="index-21.htm?page=post_video" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a>
						...
						<li class="post">
							<a href="index-22.htm?page=post_video_2" title="New Painkiller Rekindles Addiction Concerns">
								<span class="icon video"></span>
								<img src='images/samples/330x242/image_04.jpg' alt='img'>
							</a>
							<h5 class="with_number">
								<a href="index-22.htm?page=post_video_2" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a>
								<a class="comments_number" href="index-22.htm?page=post_video_2#comments_list" title="2 comments">2<span class="arrow_comments"></span></a>
							</h5>
							<ul class="post_details simple">
								<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
				...
				<div class="footer clearfix">
					<div class="row">
						...
						<div class="column column_1_3">
							...
							<div class="horizontal_carousel_container big page_margin_top">
								<ul class="blog horizontal_carousel visible-1 autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
									<li class="post">
										<a href="index-15.htm?page=post_gallery" title="Struggling Nuremberg Sack Coach Verbeek">
											<span class="icon gallery"></span>
											<img src='images/samples/330x242/image_03.jpg' alt='img'>
										</a>
										<h5 class="with_number">
											<a href="index-15.htm?page=post_gallery" title="Struggling Nuremberg Sack Coach Verbeek">Struggling Nuremberg Sack Coach Verbeek</a>
									...
									<li class="post">
										...
										<h5 class="with_number">
											<a href="index-15.htm?page=post_gallery" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a>
											<a class="comments_number" href="index-15.htm?page=post_gallery#comments_list" title="2 comments">2<span class="arrow_comments"></span></a>
										</h5>
										<ul class="post_details simple">
											<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
									...
									<li class="post">
										...
										<h5 class="with_number">
											<a href="index-15.htm?page=post_gallery" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a>
											<a class="comments_number" href="index-15.htm?page=post_gallery#comments_list" title="2 comments">2<span class="arrow_comments"></span></a>
										</h5>
										<ul class="post_details simple">
											<li class="category"><a href="index-19.htm?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
					...
					<div class="row page_margin_top_section">
						<div class="column column_3_4">
							<ul class="footer_menu">
								<li>
									<h4><a href="index-18.htm?page=category&amp;cat=world" title="World">World</a></h4>
								</li>
								<li>
									<h4><a href="index-14.htm?page=category&amp;cat=health" title="Health">Health</a></h4>
								</li>
								<li>
									<h4><a href="index-19.htm?page=category&amp;cat=sports" title="Sports">Sports</a></h4>
								</li>
								<li>
									<h4><a href="index-34.htm?page=category&amp;cat=science" title="Science">Science</a></h4>
								</li>
								<li>
									<h4><a href="index-35.htm?page=category&amp;cat=lifestyle" title="Lifestyle">Lifestyle</a></h4>
								</li>
							</ul>
						</div>
					...
					<div class="row copyright_row">
						<div class="column column_2_3">
							© Copyright <a href="https://quanticalabs.com" title="QuanticaLabs" target="_blank">QuanticaLabs</a> - PressRoom Template. <a href="../../cart/add_items.html?u=https://themeforest.net/cart/add_items?item_ids=9066845&ref=QuanticaLabs" title="PressRoom Template" target="_blank">Click here to buy it</a> 
						</div>
						<div class="column column_1_3">
							<ul class="footer_menu">
								<li>
									<h6><a href="index-9.htm?page=about" title="About">About</a></h6>
								</li>
								<li>
									<h6><a href="index-32.htm?page=authors" title="Authors">Authors</a></h6>
								</li>
								<li>
									<h6><a href="index-36.htm?page=contact" title="Contact Us">Contact Us</a></h6>
								</li>
							</ul>
						</div>
					</div>
